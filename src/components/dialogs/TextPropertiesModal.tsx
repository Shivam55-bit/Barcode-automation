                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          applyChange({ autoSize: e.target.checked, autoFit: e.target.checked });
                        }}
                      />
                      <span>Auto-Size / Auto-Fit Font (Shrink font size to fit bounding box)</span>
                    </label>

                    <div className="pt-2 border-t border-slate-200">
                      <label className="block text-[11px] font-semibold text-slate-700 mb-1">
                        Rich Text Markup Spans (Optional):
                      </label>
                      <input
                        type="text"
                        placeholder="e.g. <b>Bold</b> or <span style='color:red'>Red Text</span>"
                        value={element?.richContentHtml || ''}
                        onChange={(e) => applyChange({ richContentHtml: e.target.value })}
                        className="w-full font-mono text-[11px] border border-[#94a3b8] rounded-xs px-2.5 py-1 text-slate-900"
                      />
                      <span className="text-[10px] text-slate-500">Supports &lt;b&gt;, &lt;i&gt;, &lt;u&gt;, &lt;span style="..."&gt; inline tags.</span>
                    </div>
                  </div>
                </fieldset>
              </div>
