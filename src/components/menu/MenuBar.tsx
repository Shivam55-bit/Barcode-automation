  ...
  return (
    <div className="flex flex-col select-none z-50">
      ...
      >
        ...
        <div className="ml-auto flex items-center gap-2 pr-2 text-slate-700 text-[11px]">
          ...
          {props.onLogout && (
            <button
              ...
              className="px-2.5 py-1 bg-red-600 hover:bg-red-700 active:bg-red-800 text-white rounded text-[11px] font-bold transition-all shadow-xs cursor-pointer flex items-center gap-1.5 border border-red-700"
            >
