      ...
      <div className="h-7 bg-[#e8edf5] border-b border-[#cbd7e6] flex items-center justify-between px-2 text-slate-800 text-xs select-none shrink-0 overflow-hidden">
        ...
        <div className="flex items-center gap-2 min-w-0 flex-1">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2 py-0.5 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white rounded text-[10.5px] font-bold shadow-2xs transition-colors cursor-pointer mr-1 shrink-0"
          >
        ...
        <div className="ml-auto flex items-center gap-1 sm:gap-1.5 pr-2 text-slate-700 text-[11px] shrink-0 whitespace-nowrap pl-2">
          ...
          {props.onLogout && (
            <button
              ...
              className="px-2 py-0.5 bg-red-600 hover:bg-red-700 active:bg-red-800 text-white rounded text-[10.5px] font-bold transition-all shadow-xs cursor-pointer flex items-center gap-1 border border-red-700 whitespace-nowrap shrink-0"
            >
