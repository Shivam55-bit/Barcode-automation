...
export function getUserPersonalizedTemplates(user: { id?: string; name: string; email: string; department?: string }): LabelTemplate[] {
  const dept = user.department || 'Packaging Operations';
  const cleanName = user.name || 'Admin';
  const userPrefix = user.id || `usr-${cleanName.toLowerCase()}`;

  return [
    {
      id: `tmpl-${userPrefix}-logistics`,
      name: `${cleanName} Master Shipping Label`,
      description: `Industrial GS1-128 pallet shipping label for ${dept}`,
      category: 'Logistics',
      version: '1.0',
      status: 'draft',
      complianceStandard: 'GS1-128',
      ...
      margins: { top: 2, right: 2, bottom: 2, left: 2, bleed: 1, safeZone: 2 },
      tags: ['Logistics', 'GS1-128', 'Draft', cleanName],
      createdBy: cleanName,
      authorEmail: user.email,
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
      variables: [
        { id: 'v1', name: 'DEPT', type: 'static', defaultValue: dept.toUpperCase() },
        { id: 'v2', name: 'SSCC_CODE', type: 'static', defaultValue: '001234567000000018' },
        { id: 'v3', name: 'SERIAL_NO', type: 'counter', defaultValue: 'SN-9001', counterStart: 9001 },
      ],
      sampleRecords: [{ DEPT: dept.toUpperCase(), SSCC_CODE: '001234567000000018', SERIAL_NO: 'SN-9001' }],
      elements: [
        {
          id: 'el-hdr-1',
          name: 'Department Header',
          type: 'text',
          content: `${dept.toUpperCase()} - OUTBOUND`,
          fontSize: 12,
          fontFamily: 'Inter',
          fontWeight: 'bold',
          x: 5,
        ...
        {
          id: 'el-txt-sn',
          name: 'Serial Number Text',
          type: 'text',
          content: `SERIAL: SN-9001 • CREATED BY: ${cleanName.toUpperCase()}`,
          fontSize: 8,
          fontFamily: 'Inter',
          fontWeight: 'normal',
          x: 5,
    ...
    {
      id: `tmpl-${userPrefix}-compliance`,
      name: `${cleanName} Compliance 2D DataMatrix Label`,
      description: `High-density 2D unit serialization label for ${dept}`,
      category: 'Manufacturing',
      version: '1.0',
      status: 'draft',
      complianceStandard: 'Custom',
      ...
      margins: { top: 2, right: 2, bottom: 2, left: 2, bleed: 1, safeZone: 2 },
      tags: ['Manufacturing', 'DataMatrix', 'Draft', cleanName],
      createdBy: cleanName,
      authorEmail: user.email,
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
      variables: [
        { id: 'v1', name: 'ITEM_CODE', type: 'static', defaultValue: 'MOD-9912-A' },
        { id: 'v2', name: 'BATCH_NO', type: 'static', defaultValue: 'B-2026-08' },
      ],
      sampleRecords: [{ ITEM_CODE: 'MOD-9912-A', BATCH_NO: 'B-2026-08' }],
      elements: [
        {
          id: 'el-hdr-2',
          name: 'Component Title',
          type: 'text',
          content: `${dept.toUpperCase()} COMPONENT`,
          fontSize: 10,
          fontFamily: 'Inter',
          fontWeight: 'bold',
          x: 4,
        ...
        },
        {
          ...
          name: '2D DataMatrix',
          type: 'datamatrix',
          value: `ITEM:MOD-9912-A;BATCH:B-2026;AUTH:${cleanName}`,
          x: 4,
          y: 11,
          width: 22,
          height: 22,
